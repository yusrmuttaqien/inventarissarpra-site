...
$pinjam = mysqli_query($conn, "SELECT * FROM pinjam WHERE stats=2 ORDER BY no DESC");
$t_data = 0;
?>
...
<head>
    ...
    <link rel="stylesheet" href="../css/rwt_ijin.css">
...
<?php foreach($pinjam as $row): ?>
	<tr>
		...
		<td>
            <a href="detail_pinjam_2.php?no=<?php echo $row["no"]; ?>">Detail</a>
		</td>
	</tr>
    <?php $i++;
    $t_data++; ?>
